...
public class SnakeP1 : MonoBehaviour {
    ...
    void Update() {
        if (Input.GetKey(KeyCode.W) & !dir.Equals(y2))
            dir = Vector2.up;
        else if (Input.GetKey(KeyCode.S) & !dir.Equals(y1))
            dir = Vector2.down;
        else if (Input.GetKey(KeyCode.A) & !dir.Equals(x2))
            dir = Vector2.left;
        else if (Input.GetKey(KeyCode.D) & !dir.Equals(x1))
            dir = Vector2.right;
    }
